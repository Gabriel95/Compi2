...
public class parser {
    ...
    public parser(Lex lexer)
    {
		...
		table.put("10", "num", "d5");
		table.put("11", "$", "r5");
		table.put("11", "CLOSE", "r5");
		table.put("11", "MUL", "r5");
		table.put("11", "PLUS", "r5");
		table.put("12", "$", "r8");
		table.put("12", "CLOSE", "r8");
		table.put("12", "MUL", "r8");
		table.put("12", "PLUS", "r8");
		table.put("13", "$", "r2");
		table.put("13", "CLOSE", "r2");
		table.put("13", "MUL", "d8");
		table.put("13", "PLUS", "r2");
		table.put("2", "$", "r1");
		table.put("2", "PLUS", "r4");
		table.put("2", "PRIME", "7");
		table.put("3", "$", "r3");
		table.put("3", "CLOSE", "r3");
		table.put("3", "MUL", "d8");
		table.put("3", "PLUS", "r3");
		table.put("4", "$", "r6");
		table.put("4", "CLOSE", "r6");
		table.put("4", "MUL", "r6");
		table.put("4", "PLUS", "r6");
		table.put("5", "$", "r7");
		...
		table.put("6", "T", "3");
		table.put("6", "num", "d5");
		table.put("7", "PLUS", "d10");
		table.put("8", "F", "11");
		table.put("8", "OPEN", "d6");
		table.put("8", "num", "d5");
		table.put("9", "CLOSE", "d12");
		table.put("9", "PLUS", "r4");
		table.put("9", "PRIME", "7");
		grammarLines.add(new GrammarLine("S",new ArrayList<>(Arrays.asList("E"))));
		grammarLines.add(new GrammarLine("E",new ArrayList<>(Arrays.asList("E", "PRIME", "PLUS", "T"))));
		grammarLines.add(new GrammarLine("E",new ArrayList<>(Arrays.asList("T"))));
		grammarLines.add(new GrammarLine("PRIME",new ArrayList<>(Arrays.asList("ɛ"))));
